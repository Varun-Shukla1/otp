...
public class otp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputnum3 = findViewById(R.id.input3);
        inputnum4 = findViewById(R.id.input4);
        inputnum5 = findViewById(R.id.input5);
        inputnum6 = findViewById(R.id.input6);
        final Button verifyotpclick = findViewById(R.id.verifyotp);
        ...
        verifyotpclick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (!inputnum1.getText().toString().trim().isEmpty() && !inputnum2.getText().toString().trim().isEmpty() && !inputnum3.getText().toString().trim().isEmpty() && !inputnum4.getText().toString().trim().isEmpty() && !inputnum5.getText().toString().trim().isEmpty() && !inputnum6.getText().toString().trim().isEmpty()) {
                    String code = inputnum1.getText().toString() +
                    ...
                    if (backend != null) {
                        ...
                        verifyotpclick.setVisibility(View.INVISIBLE);
                        ...
                        FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential)
                                .addOnCompleteListener((new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        verifyotpclick.setVisibility(View.VISIBLE);
                    ...
                    Toast.makeText(otp.this, "Enter all numbers", Toast.LENGTH_SHORT).show();
                }
            }
        });
        otpmove();
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onCodeSent(@NonNull String newbackend, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                backend = newbackend;
                                Toast.makeText(otp.this, "New OTP sent Successfully", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
